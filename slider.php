  ...
  <div id="WJSlider" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" style="height: 500px">
      ...
      <div class="item active">
        <img src="" alt="slide1" width="460" height="345">
      ...
      <div class="item">
        <img src="assets/image/banner2.jpg" alt="slide2" width="460" height="345">
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
      ...
      <div class="item">
        <img src="assets/image/banner3.jpg" alt="slide3" width="460" height="345">
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
      ...
      <div class="item">
        <img src="assets/image/banner1.jpg" alt="slide4" width="460" height="345">
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
